						...
						<div class="col-md-4 step-img">
							<div class="row">
									  ...
									  <div class="card">
											  ...
											  <span class="prof-txt text-left"><strong>{{ __('Address:  ')}}</strong><span class="card-description"> {{ $profile->address }}</span></span><hr/>
											  <span class="prof-txt text-left"><strong>{{ __('Created:  ')}}</strong><span class="card-description"> {{ $profile->created_at }}</span></span>
											  <span class="prof-txt text-left"><strong>{{ __('Modified:  ')}}</strong><span class="card-description"> {{ $profile->updated_at }}</span></span>											  
									  </div>
