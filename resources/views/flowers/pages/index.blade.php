							  ...
							  <div class="col-lg-12 d-flex justify-content-center">
								...
								@if($flowerTypes->count() != 0)
									@foreach($flowerTypes as $ft)
										<button class="button" data-filter=".{{$ft->name}}">{{$ft->name}}</button>
									@endforeach
								@else
							...
							@if($flowers->count() != 0)
								@foreach($flowers as $fl)
									<div class="col-lg-4 col-md-6 gallery-item {{$fl->type}}">
										...
										@if($flowersImages->count() != 0)
											@foreach($flowersImages as $fi)
												@if($fi->ref_id == $fl->id)		
										...
										@endif
										  <div class="gallery-info">
											...
											@endif
											  ...
											  <a href="flowers/{{$fl->id}}" title="More Details"><i class="bx bx-link"></i></a>
											</div>
										  </div>
										</div>
									</div>
