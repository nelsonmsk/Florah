...
@section('body')
  ...
  <div class="col-lg-8 col-md-10 col-md-offset-2">
    ...
    <h2><span class="card-category">{{ __('Add BouquetType') }} </span> 
	<a href="{{config('app.url')}}/bouquetTypes" class="btn btn-secondary pull-right">View All</a></h2>
    </div>
	
<div class="card-body">	
    <form class="form-horizontal singleForm" id="bouquetTypes-form1" method="post" action="bouquetTypes"  data-parsley-validate>
