...
class GalleryImagesController extends Controller
{
		...
		if($request->has('search_text')){		
		   try{
		    ...
		    try{
				...
				$status = '200';
				return View('galleryImages.pages.index',compact('galleryImages','status')); 
    ...
    public function show($id)
    {
		try{ 
			...
			$status = '200';
			return View ('galleryImages.pages.show',compact('galleryImage','status'));
    ...
    public function edit($id)
    {
		try{		
			...
			$status = '200';
			return View('galleryImages.pages.edit',compact('galleryImage','status'));
