...
class Project extends Model 
{
	...
	protected $fillable = ['name','type','sdate','edate','status','description','client_id'];
    ...
    */
    ...
    public function client()
    {
     ...
     /**
     * Get the user is working on the project.
     */
    public function user()
    {
        return $this->belongsToMany(User::class)->using(Task::class);
    } 	
}
